...
var images = {
    ...
    Player_idle :"./assets/sprites/Tempo/52_92.png",
    Player_right :"./assets/sprites/Tempo/bike_R.png",
    Player_left :"./assets/sprites/Tempo/bike_L.png",
...
function loadmainmenu(){
    let y = new Entity(images.Logo,0,0,true);
        ...
        y2.onclick = () => {
            ...
            player.pos.x = lanes[1] - player.size.x/2;
            player.pos.y = cav.height * 0.85;
            player.Tx= lanes[1] - player.size.x/2;
            player.Ty = cav.height * 0.85;
...
{  
    ...
    player= new Player(images.Player_left,0,0,20);
    player.init();
    ...
    var helpAnimation = new SpriteAnimation(images.Help_animation,0,0,[0,1,2,2,1,5,5,0],500,500,2,1); 
...
class Player extends Entity{
    constructor(sprite,sizeX,sizeY,speed)
    {
        ...
        this.update = () => {
            ...
            this.pos.x = Math.clamp(this.pos.x,gamebounds[0],gamebounds[1] - this.size.x );

            let delta = this.pos.x - this.oldPosX;
        ...
        this.init = () => {      
            this.pos.x = lanes[1] - this.size.x/2;
            this.pos.y = cav.height * 0.85;  
            this.Tx = lanes[1] - this.size.x/2;
            this.Ty = cav.height * 0.85;
            this.left = new Sprite(images.Player_left,0,0,0,0);   
            this.right = new Sprite(images.Player_right,0,0,0,0);
            this.idle = new SpriteAnimation(images.Player_idle,0,0,[0],52,92,16,1);
        };
...
class Enemy extends Entity{
    constructor(sprite,sizeX,sizeY,speed)
    {
        ...
        this.update = () => {
            ...
            else if( Math.sqrt(Math.pow(player.pos.x - this.pos.x,2)+Math.pow(player.pos.x - this.pos.x,2)) <60 )
            {
...
function spawnobstacles()
{
    ...
    tempcond = obstaclesList[obstaclesList.length-1].pos.y > 0;
            ...
            {                   
                ...
                tempobst.pos.y = starty - tempobst.size.y - 200;
