...
{    
    ...
    window.resources.get(images.BG).oncanplay = window.resources.get(images.BG).play();
...
function gameOver() {    
    window.resources.get(images.GameOver).play();
    clearUI();
...
class Player extends Entity{
    constructor(sizeX,sizeY)
    {
        ...
        this.update = () => {
            ...
            { 
                if(!this.isrotating && RS2C == BL.topcode){
                    ...
                    window.resources.get(images.Bounce).play();
                }
        ...
        this.rotate = () => {
            ...
            this.isrotating = true;
            let TA = [window.resources.get(images.woosh_1),window.resources.get(images.woosh_2)];
...
{
    cxt.drawImage(window.resources.get(images.Background),0,0,cav.width,cav.height);
}
