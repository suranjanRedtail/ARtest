...
var images = {
    ...
    flip : "./assets/sprites/animations/flipping_anim.png",
    jump : "./assets/sprites/animations/jumping_anim.png",
    learn : "./assets/sprites/learn.png",
    next : "./assets/sprites/next.png",
...
function gameOver() {      
    ...
    uiEntityList.push(y);    
    uiEntityList.push(y3);  
    uiEntityList.push(learn_to_make_games);   
}
...
function HowToPlay1()
{
    ...
    let y = new Entity(flip_how_to,0,0,true);
    y.pos.x= cav.width/2 - y.size.x/2;
    y.pos.y= cav.height/2 - y.size.y/2;

    let y2 = new Button(images.next,0,0);
    y2.pos.x= cav.width/2 - y2.size.x/2;
    y2.pos.y= 963;
...
function HowToPlay2()
{
    ...
    let y = new Entity(jump_how_to,0,0,true);
    y.pos.x= cav.width/2 - y.size.x/2;
    y.pos.y= cav.height/2 - y.size.y/2;
...
function init()
{
    ...
    jump_how_to = new SpriteAnimation(images.jump,0,0,[0,1],329,429,1,1);
    flip_how_to = new SpriteAnimation(images.flip,0,0,[0,1],329,429,1,1);
    jump_how_to.loop = true;
    flip_how_to.loop = true;

    learn_to_make_games = new Button(images.learn,0,0);
    learn_to_make_games.onclick = ()=>{
        window.location = "http://redtailstudio.com";
    }
    
    learn_to_make_games.pos.x=cav.width/2 - learn_to_make_games.size.x/2;
    learn_to_make_games.pos.y=cav.height * 0.75 - learn_to_make_games.size.y;
